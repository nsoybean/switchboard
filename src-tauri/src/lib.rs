...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::pty::quit_with_cleanup,
            ...
            commands::claude_data::delete_claude_sessions_batch,
            ...
            commands::codex_data::delete_codex_sessions_batch,
            commands::session_metadata::rename_session_metadata,
            commands::session_metadata::delete_session_metadata,
            commands::session_metadata::delete_session_metadata_batch,
            ...
            commands::session::delete_sessions_batch,
            ...
            commands::session::save_workspace_layout,
            commands::session::load_workspace_layout,
