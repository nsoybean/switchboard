...
Open-source multi-agent orchestrator for AI coding agents (Codex, Codex).
...
- Session data: reads from ~/.Codex/projects/ (Codex storage), writes own metadata to ~/.switchboard/sessions.json
